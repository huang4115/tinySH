...
#define OS_TASK_TMR_PRIO          2u   /*     OSTmr_Task is Priority                                   */ 

/**
 * 将ms转换成tick , 先乘后除。
 * 若为 (OS_TICKS_PER_SEC/1000*m_secs), 当OS_TICKS_PER_SEC<1000时,计算结果始终为 0 .
 */
#define	MS_TO_TICKS(m_secs)      (OS_TICKS_PER_SEC*m_secs/1000)
